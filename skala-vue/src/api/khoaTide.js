...
// https://www.data.go.kr/data/15156018/openapi.do (Base URL: apis.data.go.kr/1192136/tideFcstHghLw)
const BASE = '/khoa/GetTideFcstHghLwApiService'

/**
 * "YYYY-MM-DD HH:mm" → epoch ms. 브라우저 로컬 타임존(KST 실행 가정)으로 파싱한다.
 * @param {string} predcDt
 * @returns {number}
 */
 ...
 * @param {object} raw
 * @returns {import('@/utils/tideCurve').TideExtremum[]}
 */
 ...
 * @returns {Promise<import('@/utils/tideCurve').TideExtremum[]>}
 */
