 ...
 * "물이 세게 흐르는 구간" 판정(§5 낚시 모드)에 쓰인다.
 * @param {Array<{t: number, level: number}>} series
 * @returns {Array<{t: number, level: number, slope: number}>}
 */
